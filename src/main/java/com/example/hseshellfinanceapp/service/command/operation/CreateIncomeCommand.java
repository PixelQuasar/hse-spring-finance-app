...
public class CreateIncomeCommand extends Command<Optional<Operation>> {
    ...
    public Optional<Operation> execute() {
        return operationFacade.createIncome(accountId, categoryId, amount, date, description);
    }
    ...
    public String getHelp() {
        return "CREATE INCOME COMMAND\n" +
                "Creates a new income operation.\n" +
                "Usage: create-income <account-id> <category-id> <amount> [date] [description]\n" +
                "- account-id: UUID of the account (required)\n" +
                "- category-id: UUID of the income category (required)\n" +
                "- amount: Income amount, must be positive (required)\n" +
    ...
    public String getDescription() {
        return "Create a new income operation";
    }
}
